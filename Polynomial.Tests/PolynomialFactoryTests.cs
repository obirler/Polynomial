...
namespace Polynomial.Tests
{
    ...
    public class PolynomialFactoryTests
    {
        ...
        {
            // Arrange
            Debug.WriteLine("TEST: Create_WithExpression_CreatesValidPolynomial");
            Debug.WriteLine("Testing: Creating polynomial using factory");
            ...
            Debug.WriteLine($"Created polynomial: {poly}");
            ...
            Debug.WriteLine($"At x={x}: {x}^2 + 1 = {expected}");
