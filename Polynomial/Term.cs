...
namespace Polynomial
{
    public class Term
    {
        ...
        static Term()
        {
            DotCulture = (CultureInfo)Thread.CurrentThread.CurrentCulture.Clone();
        ...
        public override string ToString()
        {
            ...
            if (Coefficient != 0)
            {
                ...
                if (this.Power == 0)
                    Result += (this.Coefficient < 0 ? this.Coefficient * -1 : this.Coefficient).ToString(DotCulture);
                else if (this.Power == 1)
                {
                    ...
                    else
                    {
                        Result += string.Format("{0}x",
                            (this.Coefficient < 0 ? this.Coefficient * -1 : this.Coefficient).ToString(DotCulture));
                    }
                }
                else
                {
                    if (System.Math.Round(Coefficient, 10) == 1)
                    {
                        Result += "x^" + this.Power.ToString(DotCulture);
                    }
                    else if (System.Math.Round(Coefficient, 10) == -1)
                    {
                        Result += "x^" + this.Power.ToString(DotCulture);
                    ...
                    {
                        Result += string.Format("{0}x^{1}", (this.Coefficient < 0 ? this.Coefficient * -1 : this.Coefficient).ToString(DotCulture), this.Power.ToString(DotCulture));
                    }
        ...
        public string GetString(int digit)
        {
            ...
            if (Coefficient != 0)
            {
                ...
                if (this.Power == 0)
                    Result += (this.Coefficient < 0 ? OrgMath.Round(this.Coefficient * -1, digit) : OrgMath.Round(this.Coefficient, digit)).ToString(DotCulture);
                else if (this.Power == 1)
                {
                    if (Coefficient == 1)
                    {
                    ...
                    {
                        Result += string.Format("{0}x",
                            (this.Coefficient < 0 ? OrgMath.Round(this.Coefficient * -1, digit) : OrgMath.Round(this.Coefficient, digit)).ToString(DotCulture));
                    }
                }
                else
                {
                    ...
                    {
                        Result += string.Format("{0}x^{1}", (this.Coefficient < 0 ? OrgMath.Round(this.Coefficient * -1, digit) * -1 : OrgMath.Round(this.Coefficient, digit)).ToString(DotCulture), this.Power.ToString(DotCulture));
                    }
        ...
        public static CultureInfo DotCulture;
        /// <summary>
